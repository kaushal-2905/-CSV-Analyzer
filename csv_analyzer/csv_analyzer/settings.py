...
SECRET_KEY = 'django-insecure-namdv2+m1=d17_$qljel*a3z^&g_8np9am8rd@50$jv7uyhs#7'
...
INSTALLED_APPS = [
    ...
    "analyzer",  # Custom app for CSV analysis
]
...
# Media (for uploaded files and generated plots)
MEDIA_URL = '/media/'
